...
public class SpringControllerCollects extends AbstractCollects implements Collect {
    ...
    static {
        ...
        sbuilder.append("com.bit.monitoring.agent.collects.SpringControllerCollects instance= ");
        sbuilder.append("com.bit.monitoring.agent.collects.SpringControllerCollects.INSTANCE;\r\n");
        sbuilder.append("com.bit.monitoring.agent.collects.SpringControllerCollects.WebStatistics statistic =(com.bit.monitoring.agent.collects.SpringControllerCollects.WebStatistics)instance.begin(\"%s\",\"%s\");");
